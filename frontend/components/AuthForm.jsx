...
const AuthForm = ({ type }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (type === "sign-up") {
        // For sign-up (keep FormData for file uploads)
        ...
        await createAccount(formDataToSend);
      } else {
        // For login (use plain object)
            ...
            <div className="mt-6">
              <Link
               href={type === "sign-in" ? "/sign-up" : "/sign-in"}
                className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-pink-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
